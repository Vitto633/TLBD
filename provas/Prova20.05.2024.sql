...
-- exercicio 01
select cod_clie, nome_clie from cliente where cod_clie between 200 and 300 order by cod_clie asc;

-- exercicio 02
select * from pedido where num_pedido between 0 and 101 or num_pedido > 140 order by num_pedido asc;

-- exercicio 03
select * from vendedor where comissao like 'a' or comissao like 'b'; 

-- exercicio 04
select * from produto where unidade not in('m','g','l');
...
-- exercicio 13
select nome_clie from cliente where nome_clie like '%e%o%';

-- exercicio 14
select nome_clie from cliente where nome_clie not like '%u%';

-- exercicio 15
select nome_clie from cliente where nome_clie like '%a%' or nome_clie like '%e%';